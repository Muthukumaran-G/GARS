...
namespace GarageApp.ViewModels
{
    ...
    [DataContract]
    public class GarageNoInternetPageViewModel : BaseViewModel
    {
        #region Fields

        private static GarageNoInternetPageViewModel noInternetConnectionPageViewModel;
        ...
        /// <summary>
        /// Initializes a new instance for the <see cref="GarageNoInternetPageViewModel" /> class.
        /// </summary>
        public GarageNoInternetPageViewModel()
        {
        }
        ...
        /// </summary>
        public static GarageNoInternetPageViewModel BindingContext =>
            noInternetConnectionPageViewModel = PopulateData<GarageNoInternetPageViewModel>("errorAndEmpty.json");
