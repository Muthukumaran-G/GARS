...
namespace GarageApp.Validators
{
    /// <summary>
    ...
    public class ValidatableObject<T> : IValidatable<T>
    {
        ...
        public virtual bool Validate(ValidatableObject<T> messageObject = null)
        {
            this.Errors.Clear();
            ...
            {
                errors = this.Validations.Where(v => !v.Check(this.Value))
                .Select(v => v.ValidationMessage);
            }
            else
            {
                errors = this.Validations.Where(v => !v.CheckForPairs(this.Value, messageObject.Value))
                .Select(v => v.ValidationMessage);
            }
